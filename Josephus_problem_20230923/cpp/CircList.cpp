...
CircLinkNode* CircList::getHead() const
{
	return first;
}
;
//返回表头结点地址
void CircList::setHead(CircLinkNode* p)
{
	first = p;
};
//设置表头结点地址
CircLinkNode* CircList::Search(int x)
{
...
;//定位
int CircList::getData(int i)
{
	return Locate(i)->data;
};
void CircList::setData(int i, int x)
{
